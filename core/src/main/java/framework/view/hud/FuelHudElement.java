...
public class FuelHudElement implements HudElement {
    ...
    public FuelHudElement(Stage stage, Label.LabelStyle style, EntityStorage entityStorage) {
        ...
        float barWidth  = 50;
        float barHeight = 260;
        Drawable backgroundFuel = UIAssetFactory.createBarDrawable(new Color(0.1f, 0.1f, 0.1f, 1), (int) barWidth, (int) barHeight);
        Drawable orangeFuel  = UIAssetFactory.createBarDrawable(Color.ORANGE, (int) barWidth, (int) barHeight);
        Drawable fuelBorder = UIAssetFactory.createBorderDrawable((int) barWidth, (int) barHeight);
