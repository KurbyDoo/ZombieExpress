...
public class HealthHudElement implements HudElement {
    ...
    public HealthHudElement(Stage stage, Player player) {
        ...
        float barWidth = 260;
        float barHeight = 30;
        Drawable redHealth = UIAssetFactory.createBarDrawable(new Color(0.3f, 0, 0, 1),
            (int) barWidth, (int) barHeight);
        Drawable greenHealth = UIAssetFactory.createBarDrawable(Color.GREEN,
            (int) barWidth, (int) barHeight);
        Drawable healthBorder = UIAssetFactory.createBorderDrawable(
            (int) barWidth, (int) barHeight);
