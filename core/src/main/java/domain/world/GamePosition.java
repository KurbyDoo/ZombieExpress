...
public class GamePosition implements Serializable {
    ...
    public GamePosition mul4x3(float[] matrix) {
        return this.set(this.x * matrix[0] + this.y * matrix[3] + this.z * matrix[6] + matrix[9],
    ...
    public GamePosition traMul(Matrix4 matrix) {
        float[] l_mat = matrix.val;
        return this.set(this.x * l_mat[0] + this.y * l_mat[1] + this.z * l_mat[2] + l_mat[3],
    ...
    public GamePosition mul(Matrix3 matrix) {
        float[] l_mat = matrix.val;
        return this.set(this.x * l_mat[0] + this.y * l_mat[3] + this.z * l_mat[6],
    ...
    public GamePosition traMul(Matrix3 matrix) {
        float[] l_mat = matrix.val;
        return this.set(this.x * l_mat[0] + this.y * l_mat[1] + this.z * l_mat[2],
    ...
    public GamePosition prj(Matrix4 matrix) {
        ...
        return this.set((this.x * l_mat[0] + this.y * l_mat[4] + this.z * l_mat[8] + l_mat[12]) * l_w,
    ...
    public GamePosition rot(Matrix4 matrix) {
        float[] l_mat = matrix.val;
        return this.set(this.x * l_mat[0] + this.y * l_mat[4] + this.z * l_mat[8],
    ...
    public boolean isOnLine(GamePosition other) {
        return len2(this.y * other.z - this.z * other.y, this.z * other.x - this.x * other.z,
            this.x * other.y - this.y * other.x) <= 1.0E-6F;
    }
