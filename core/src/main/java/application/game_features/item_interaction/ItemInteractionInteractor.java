...
import application.game_features.dismount_entity.DismountEntityInputData;
import application.game_features.mount_entity.MountEntityInputBoundary;
import application.game_features.mount_entity.MountEntityInputData;
import application.game_features.mount_entity.MountEntityOutputData;
...
public class ItemInteractionInteractor implements ItemInteractionInputBoundary {
    ...
    private boolean attemptFuelTrain(Train train) {
        if (train == null || !isHoldingFuel() || findTrainInFront() != train ||
            train.getCurrentFuel() >= train.getMaxFuel()) {
            return false;
        }
