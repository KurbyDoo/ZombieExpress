...
import application.game_features.player_movement.PlayerMovementInputData;
...
public class GameInputAdapter extends InputAdapter {
    ...
    public GameInputAdapter(PlayerMovementInputBoundary playerMovementInteractor, ExitGameUseCase exitGameUseCase,
                            Player player) {
