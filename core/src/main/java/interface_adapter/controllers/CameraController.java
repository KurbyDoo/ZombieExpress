...
import application.game_features.query_camera_data.QueryCameraDataInputBoundary;
...
public class CameraController {
    ...
    public void updatePrevious() {
        ...
        previousUp.set(currentData.getUpwards());
    }
    ...
    public void renderCamera(float alpha) {
        ...
        GamePosition currentUp = currentData.getUpwards();
