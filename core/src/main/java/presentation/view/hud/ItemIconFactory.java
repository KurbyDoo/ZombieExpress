...
public class ItemIconFactory {
    ...
    static {
        ...
        Texture oilBarrelTexture = new Texture(Gdx.files.internal("models/items/fuels/oil_barrel/icons/oil_barrel.png"));
        Texture rustyPistolTexture = new Texture(Gdx.files.internal("models/items/weapons/pistols/icons/rusty_pistol.png"));
        Texture metalPistolTexture = new Texture(Gdx.files.internal("models/items/weapons/pistols/icons/combat_pistol.png"));
        Texture goldPistolTexture = new Texture(Gdx.files.internal("models/items/weapons/pistols/icons/golden_pistol.png"));
        Texture rainbowPistolTexture = new Texture(Gdx.files.internal("models/items/weapons/pistols/icons/rainbow_pistol.png"));
        Texture blackRifleTexture = new Texture(Gdx.files.internal("models/items/weapons/rifles/icons/tactical_rifle.png"));
        Texture goldRifleTexture = new Texture(Gdx.files.internal("models/items/weapons/rifles/icons/golden_rifle.png"));
        Texture redRifleTexture = new Texture(Gdx.files.internal("models/items/weapons/rifles/icons/zombie_obliterator_rifle.png"));
